...
export default function AddVehicleForm() {
    ...
    return (
        <form
            action="/auth/make-post"
            method="post"
            className="flex flex-col space-y-3 w-2/3 h-full border-2 border-blue-800 p-5 rounded-md mb-5"
        >
            ...
            <label>Images</label>
            {/* UploadImage handles immediate upload and stores only file names */}
            <UploadImage />
            ...
            <label>Videos</label>
            <VideoLink /> {/* Only handles YouTube URLs */}
            ...
            <button type="submit" className="p-2 bg-blue-800 font-semibold rounded-md">Submit</button>
        </form>
    )
}